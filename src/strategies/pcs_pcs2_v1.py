...
RAISE_AT_EXCESSIVE_GS_PRICE = False
...
def run():
    ...
    arbitrage_pairs = [
        PcsPcs2(
            ...
            raise_at_excessive_gas_price=RAISE_AT_EXCESSIVE_GS_PRICE,
            **params,
        )
        for params in get_arbitrage_params(dexes['pcs_dex'], dexes['pcs2_dex'])
    ]
